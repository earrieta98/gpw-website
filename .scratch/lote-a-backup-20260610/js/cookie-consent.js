...
(function() {
  ...
  style.textContent = [
    ...
    '.cc-btn--accept{background:#F27257;color:#1A1A1A;border-color:#F27257;}',
    '.cc-btn--accept:hover{background:#E0613F;border-color:#E0613F;}',
    ...
    '.cc-inner{flex-direction:column;text-align:center;gap:10px;}',
    '.cc-actions{width:100%;justify-content:center;}',
    '.cc-btn{padding:9px 20px;}',
    '.cc-text{flex-basis:100%;font-size:13px;line-height:1.5;}',
    '.cc-text__detail{display:none;}}'
  ].join('\n');
  ...
  banner.innerHTML =
    '<div class="cc-inner">' +
      '<p class="cc-text">' +
        ...
        '<span class="cc-text__detail">By clicking &ldquo;Accept,&rdquo; you consent to our use of analytics cookies. </span>' +
